\documentclass[10pt,legalpaper,ragged2e,withhyper]{debjitpalcv}
...
\begin{paracol}{2}
    ...
    \begin{sloppypar*}
        ...
        \medskip
        \cvtags{MySQL, Git, Machine Learning, Deep Learning, Data Science}\\
        \medskip
        \cvtags{Azure Databricks}
    \end{sloppypar*}
    ...
    \cvevent{Systems Engineer}{TCS}{Aug 2023 -- Current}{Kolkata, West Bengal}
